...
# Mps
class TestNetworkWithSingleParentsMps(TestTorchNaiveInferenceMachineBaseMps, TorchInferenceMachineGenericTests.NetworkWithSingleParents): pass
class TestComplexNetworkWithSingleParentsMps(TestTorchNaiveInferenceMachineBaseMps, TorchInferenceMachineGenericTests.ComplexNetworkWithSingleParents): pass
class TestNetworkWithMultipleParentsMps(TestTorchNaiveInferenceMachineBaseMps, TorchInferenceMachineGenericTests.NetworkWithMultipleParents): pass
